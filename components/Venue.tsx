  ...
  return (
    <section className="py-24 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          <span className="text-accent uppercase tracking-widest font-bold text-sm mb-4 block">The Venue</span>
          <h2 className="text-5xl md:text-6xl mb-8 leading-tight">{VENUE_DETAILS.name}</h2>
          <p className="text-xl serif-text italic text-gray-300 mb-8 max-w-lg leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">{VENUE_DETAILS.address}</p>
              </div>
            </div>
        ...
        <div className="h-[500px] w-full bg-gray-800 rounded-2xl overflow-hidden shadow-2xl relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
             <div className="p-8 bg-white text-gray-900 rounded-lg shadow-xl text-center">
                ...
                <a 
                  href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(VENUE_DETAILS.address)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-6 py-2 bg-gray-900 text-white text-sm font-bold uppercase tracking-wider rounded hover:bg-accent transition-colors"
                >
                  Get Directions
                </a>
             </div>
